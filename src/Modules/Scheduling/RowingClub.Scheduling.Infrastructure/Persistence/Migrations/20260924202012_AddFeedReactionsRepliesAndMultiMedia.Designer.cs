...
namespace RowingClub.Scheduling.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924202012_AddFeedReactionsRepliesAndMultiMedia")]
    partial class AddFeedReactionsRepliesAndMultiMedia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Appointments.Appointment", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RsvpResolvedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("RsvpDeadlineUtc")
                        .HasFilter("\"RsvpResolvedAtUtc\" IS NULL");

                    b.HasIndex("RsvpTokenHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.CommentLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CommentId", "CustomerId")
                        .IsUnique()
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.PollOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.PollVote", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.Post", b =>
                {
                    ...
                    b.Property<DateOnly?>("PollClosesOn")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.PostReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.CommentLike", b =>
                {
                    b.HasOne("RowingClub.Scheduling.Domain.Community.PostComment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RowingClub.Scheduling.Domain.Community.PollVote", b =>
                {
                    ...
                    b.HasOne("RowingClub.Scheduling.Domain.Community.PollOption", null)
                        .WithMany()
