    ...
    : IClassFixture<RowingClubWebApplicationFactory>
{
    public static TheoryData<string, HttpMethod> ProtectedEndpoints => new()
    {
        ...
        { "/api/v1/company/site/content", HttpMethod.Get },
        { "/api/v1/company/site/content", HttpMethod.Put },
        { "/api/v1/company/site/logo", HttpMethod.Post },
        { "/api/v1/company/site/gallery", HttpMethod.Post },
        { "/api/v1/company/site/gallery/e9a7e1b1-0000-0000-0000-000000000001", HttpMethod.Delete },
        { "/api/v1/company/site/messages", HttpMethod.Get },
        { "/api/v1/company/site/messages/e9a7e1b1-0000-0000-0000-000000000001/reply", HttpMethod.Post },
        ...
        { "/api/v1/company/appointments/e9a7e1b1-0000-0000-0000-000000000001/move", HttpMethod.Post },
        ...
        { "/api/v1/company/feed/e9a7e1b1-0000-0000-0000-000000000001/media/0", HttpMethod.Get },
        { "/api/v1/company/feed/e9a7e1b1-0000-0000-0000-000000000001/likes", HttpMethod.Get },
        { "/api/v1/company/feed/e9a7e1b1-0000-0000-0000-000000000001/react", HttpMethod.Post },
        { "/api/v1/company/feed/e9a7e1b1-0000-0000-0000-000000000001/reactions", HttpMethod.Get },
        { "/api/v1/company/feed/e9a7e1b1-0000-0000-0000-000000000001/comments", HttpMethod.Post },
        { "/api/v1/company/feed/comments/e9a7e1b1-0000-0000-0000-000000000001/like", HttpMethod.Post },
        { "/api/v1/company/feed/comments/e9a7e1b1-0000-0000-0000-000000000001/delete", HttpMethod.Post },
        ...
        { "/api/v1/member/heartbeat", HttpMethod.Post },
        ...
        { "/api/v1/member/feed/e9a7e1b1-0000-0000-0000-000000000001/media/0", HttpMethod.Get },
        { "/api/v1/member/feed/e9a7e1b1-0000-0000-0000-000000000001/react", HttpMethod.Post },
        { "/api/v1/member/feed/comments/e9a7e1b1-0000-0000-0000-000000000001/like", HttpMethod.Post },
        { "/api/v1/member/feed/comments/e9a7e1b1-0000-0000-0000-000000000001/delete", HttpMethod.Post },
        ...
        { "/api/v1/platform/payments", HttpMethod.Get },
        { "/api/v1/platform/payments/stats", HttpMethod.Get },
        ...
        { "/api/v1/platform/dev/wipe-all-data", HttpMethod.Post },
        { "/api/v1/platform/databases", HttpMethod.Get },
        { "/api/v1/platform/databases/tenant_orphan/drop", HttpMethod.Post },
